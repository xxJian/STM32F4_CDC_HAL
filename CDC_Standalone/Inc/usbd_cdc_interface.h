...
#ifdef STM32_V5	// for STM32_V5 board
...
#define TIMx_FORCE_RESET()               __USART1_FORCE_RESET()
#define TIMx_RELEASE_RESET()             __USART1_RELEASE_RESET()

#else	// for STM324xG_Eval & STM32F4-Discovery
